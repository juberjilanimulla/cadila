...
const managerjobapplicantsRouter = Router();

managerjobapplicantsRouter.post("/getall", getalljobapplicantsHandler);
managerjobapplicantsRouter.post("/delete", deletejobapplicantsHandler);
export default managerjobapplicantsRouter;
